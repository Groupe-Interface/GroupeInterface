 ...
 */
final class Version20210708182411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE specialite ADD departement_id INT DEFAULT NULL, DROP departement');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE specialite ADD departement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP departement_id');
    }
}
